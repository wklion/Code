...
*
* */
function DateSelecter(minView,startView,minuteStep,format){
    this.div = null;
    this.leftBtn = null;
    this.rightBtn = null;
    this.input = null;
    ...
    this.minuteStep = (minuteStep ? minuteStep : 6);//最小视图分钟间隔数
    //创建选择框
    this.createInput = function(){
        ...
        this.leftBtn = $("<img>")
            .addClass("dateBtn")
            .attr("src","imgs/dateBtn1.png")
            .appendTo(this.div).click(function(){
                t.changeHours(-1*t.intervalMinutes);
            });
        this.input = $("<input>")
            .attr({
                "style":"width:150px;color:#5B5B5B;height:auto",
                "type":"text",
