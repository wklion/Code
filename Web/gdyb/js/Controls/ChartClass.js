...
//显示图表
ChartClass.prototype.displayChart = function(){
    var t  = this;
    if(t.myLineChart == null)
        t.myLineChart = new Chart(document.getElementById("canvas").getContext("2d")).Line(t.lineChartData);
    else
    {
        this.myLineChart.setData(t.lineChartData);
