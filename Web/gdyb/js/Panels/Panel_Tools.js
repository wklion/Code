...
function Panel_Tools(div){
    ...
    this.createPanelDom = function(){
        this.panel = $("<div id=\"Panel_Tools\" class=\"noDragPanel\">"
           ...
           /* +"<div style=\"background-color: #3c85bc;height: 2px;margin-bottom: 5px;margin-top: 5px\"/>" *//*分隔线*/
            ...
            +"<div style='margin-bottom: 8px;'><div id='div_title' style='display:inline-block;height: 27px;line-height:27px;text-align:center;font-size: 14px;margin-left: 10px;'>日降水量</div><div style='margin: 0px 6px 2px 0px; float:right;'><select id='selectFillColorType' style='width:60px;height:20px;margin:2px;padding: 0px;    background-color: rgb(3,66,94);color: white;border-color: rgb(34,143,188);'><option value=\"国标\">国标</option><option value=\"值域\">值域</option></select></div></div>"
            +"<div id='div_GridValueItems'></div>"
            +"</div>"
            +"<div class=\"row1\" ><span style='line-height: 25px;'>格点量级：</span></span><input id='gridValueDown' style='width: 50px;height: 25px;padding-left: 5px;font-weight: bold;margin: 0px;background-color: rgb(3,66,94);color: white;border: 1px solid rgb(34,143,188);padding-left: 15px;' type='text' value=''/><span id='gridValueDownToUp' style='color:rgb(34,143,188)'> - </span><input id='gridValueUp' style='width: 50px;height: 25px;padding-left: 5px;font-weight: bold;margin: 0px;background-color: rgb(3,66,94);color: white;border: 1px solid rgb(34,143,188);padding-left: 15px;' type='text' value=''/></div>"
            +"</div>"
            ...
            +"<div id='div_windDirectionItems' style='background: rgb(3,66,94);'><table id='table_windDirectionItems' style='width: 100%;text-align: center;text-align: left;margin-left: 10px'>"
            ...
            +"<div class='smallTitle' ><span>仅赋值到站点</span><div class='checkboxCircle'><label id='labelStation' value='0'></label></div></div>"
            +"</div>"
            ...
            /*+"<div style=\"background-color: #3c85bc;height: 2px;margin-bottom: 5px;margin-top: 5px\"/>" *//*分隔线*/
            +"<div id=\"div_qhPicker\" style=\"display: none\" class=\"row1\"><select id='selectClimaticRegionType_QH' style='width:90px;height:25px;line-height:25px;margin-top:5px;    background-color: rgb(3,66,94);color: white;border: 1px solid rgb(34,143,188);'><option>无</option></select><span><span>：</span><select id='selectClimaticRegionItem_QH' style='width:90px;height:25px;line-height:25px;margin-top:5px;'><option>无</option></select></div>"
            ...
            +"<button class=\"button button-rounded\" style=\"width:60px;line-height:24px;height:30px;padding: 0 2px;background-color: rgb(3,66,94);color: white;border: 1px solid rgb(34,143,188);\">+0.1<i style=\"margin-left:4px;color:rgb(34,143,188);\" class=\"fa fa-caret-down\"></i></button>"
            ...
            +"<button id='btn_move' style=\"width:40px;line-height:24px;height:30px;padding: 1px 0px 0px 2px;background-color: rgb(49,202,255);border: 1px solid rgb(49,202,255);\">移动</button><button id='btn_copy' style=\"width:40px;line-height:24px;height:30px;padding: 1px 0px 0px 2px;background-color: rgb(49,202,255);border: 1px solid rgb(49,202,255);\">复制</button><button id='btn_modify' style=\"width:40px;line-height:24px;height:30px;padding: 1px 0px 0px 2px;background-color: rgb(49,202,255);border: 1px solid rgb(49,202,255);\">修改</button><button id='btn_modifyWindDirection' style=\"display:none;width:40px;line-height:24px;height:30px;padding: 1px 0px 0px 2px;background-color: rgb(49,202,255);border: 1px solid rgb(49,202,255);\">风向</button>"
            +"</div>"
            ...
            +"</div>"
            /*滑块提示*/
            +"<div id=\"divRangeTip\" style=\"display:none;width:30px;height: 20px;position:absolute;top:0px;left:0px;background-color: #FFFFFF;color: #000000;z-index: 99;text-align:center;font-size: 12px;\"></div>"
            +"</div>")
            .appendTo(this.div);

        var t = this;

        $(".panelToolsNew").html("<div id='div_tools' style='background-color: #012E4C;'>"
            +"<div id='img_tool_pan' title=\"移动地图\" ></div>"
            +"<div id='img_tool_full' title=\"全屏显示\" ></div>"
            +"<div id='img_tool_drawluoqunone' title=\"绘制落区\" ></div>"
            +"<div id='img_tool_drawluoqu' title=\"区域赋值\" ></div>"
            +"<div id='img_tool_pickluoqu' title=\"拾取落区\" ></div>"
            +"<div id='img_tool_stamp' title=\"盖章\" ></div>"
            +"<div id='img_tool_brush' title=\"画刷\" ></div>"
            +"<div id='img_tool_wind' title=\"风向订正\"></div>"
            +"<div id='img_tool_editcell' title=\"单元格编辑\" ></div>"
            +"<div id='img_tool_qhdz' title=\"区划订正\" ></div>"
            +"<div id='img_tool_modifytrend' title=\"趋势订正\"></div>"
            +"<div id='img_tool_erase' title=\"橡皮擦\"></div>"
            +"<div id='img_tool_undo' title=\"撤销\" ></div>"
            +"<div id='img_tool_redo' title=\"重做\" ></div>"
//            +"<div class=\"row1\" style=\"text-align: center;\"><img id='img_tool_showArea' src=\"imgs/img_tool_showArea.png\"/></div>"
            +"</div>");
        $("#map_div").css("left","1px").css("margin-left","0px");
        ...
        //点击工具
        $("#div_tools").find("div").click(function(){
            ...
            {
                t.toInitialState();
                $("#div_tools").find("div").removeClass("active");
            ...
            if(this.id == "img_tool_full"){
                GDYB.Page.curPage.map.zoomToExtent(new WeatherMap.Bounds(91,32,110,43));
            }

            if(this.id != "img_tool_pan" && this.id != "img_tool_full"&& GDYB.GridProductClass.dataCache == null){
                ...
                if(!t.hasAddStampMouseWheelEvent) {
                    ...
                    addEvent(mapDiv, 'mousewheel', function (e) {
                        if (t.m_activeTool == "img_tool_stamp") {
                            if (e.detail == 0) {
                                t.brushSize += 1 * e.wheelDelta / Math.abs(e.wheelDelta);
                            }
                            else {
                                t.brushSize += 1 * e.detail / Math.abs(e.detail);
                            }
...
//                stopDragMap();
                ...
                stopDragMap();
                t.dgLast = GDYB.GridProductClass.dataStack.get(GDYB.GridProductClass.dataStack.stack.length - (GDYB.GridProductClass.dataStack.stack.length>1?2:1)); //-1是最后一个，-2是上一次编辑前的格点，要的就是它
        ...
        $("#div_tools").find("span").click(function(){
            $(this).prev().click();
        });
...
//                alert("上限值不能小于下限值");
        ...
        $("#rangeValue").mousemove(function(e){
            if(e.buttons == 1 && e.offsetX >= 0 && e.offsetX <= this.offsetWidth) {
                var tip = $("#divRangeTip");
...
//                replaceGrid(Number(value), method);
        ...
        $("#divInputValue_input").change(function(){
            if(pt == null || $("#divInputValue_input").val() == "")
                return;
            $("#divInputValue").css("display", "none");
            GDYB.GridProductClass.datasetGrid.setValue(0, pt.x, pt.y, $("#divInputValue_input").val());
            GDYB.GridProductClass.layerFillRangeColor.refresh();
            GDYB.GridProductClass.dataCache.setDataStatus(GDYB.GridProductClass.currentMakeTime, GDYB.GridProductClass.currentVersion, GDYB.GridProductClass.currentDateTime,  GDYB.GridProductClass.currentElement,  GDYB.GridProductClass.currentHourSpan, 1, GDYB.GridProductClass.datasetGrid); //更新已修改状态
            GDYB.GridProductClass.dataStack.push( GDYB.GridProductClass.datasetGrid); //压入堆栈
            GDYB.GridProductClass.updateStationLayer();
...
//                                if(bWind)
//                                    dg.setValue(1, x, y, t.dgLast.grid[y][x].direction);
                                modified = true;
                            }
                        }
    ...
    this.updateUI = function(element, elementName, toInitialState){
        ...
        if(GDYB.GridProductClass.layerFillRangeColor != null && GDYB.GridProductClass.layerFillRangeColor.items != null) {
            ...
            if(typeof(styles[0].caption) == "undefined"){
                strHtml = "<table id='table_GridValueItems' style='width: 100%;text-align: center;color: white;'>";
                var cols = 5;
                var count = 1;
                var strTD = "";
                for (var key in styles) {
                    ...
                    strTD += "<td id='" + style.start + "_" + style.end+"'" + strTag + "><span style='border-radius: 100%;display:inline-block;width:32px;height:32px;text-align:center;line-height:32px;background:rgb(" + style.startColor.red + "," + style.startColor.green + "," + style.startColor.blue + ")'>" + style.start + "</span></td>";
                    if (count % cols == 0) {
                        strHtml += "<tr>" + strTD + "</tr>";
                        strTD = "";
                    }
                ...
                for (var key in styles) {
                    var style = styles[key];
                    var strTag = typeof(style.tag)=="undefined"?"":" tag='"+style.tag+"'";
                    strTD += "<td id='" + style.start + "_" + style.end + "'" + strTag + " style='padding:5px 0px 0px 0px;text-align: center;'><span style='border-radius: 100%;display:inline-block;width:20px;height:20px;background:rgb(" + style.startColor.red + "," + style.startColor.green + "," + style.startColor.blue + ")'><span class='luoquButton' style='display:none;width:20px;height:20px;border:3px solid #fff;;background:rgb(" + style.startColor.red + "," + style.startColor.green + "," + style.startColor.blue + ")'></span></span><span style='vertical-align: top;display: inline-block;line-height: 22px;margin-left: 2px;width: 25px;white-space:nowrap;overflow: hidden;' title='" + style.caption + "'>" + style.caption + "</span></td>";
                    if (count % cols == 0) {
                        strHtml += "<tr>" + strTD + "</tr>";
                        strTD = "";
                    }
