...
function SZMSPageClass(){
    ...
    this.renderMenu = function(){
        var htmlStr = "<div id='div_type'><div class='title1'>模式</div>"
            +"<div class='btn_line1 menuDiv_bottom1' ><button id='ec'>EC-Thin</button><button id='ger'>Germany</button><button id='t639'>T639</button><button id='japan'>Japan</button><button id='bj'>中央台</button></div>"
            +"</div>"
            +"<div id='div_element'><div class='title1'>要素</div>"
            +"<div class='btn_line menuDiv_bottom1'><button id='r12'>日降水量</button><button id='tmax'>日最高温</button><button id='tmin'>日最低温</button>"
            +"<button id='r3'>降水量</button><button id='2t'>气温</button><button id='rh'>相对湿度</button>"
            +"<button id='10uv'>10米风</button><button id='tcc'>云量</button><button id='vis'>能见度</button></div>"
            +"<div class='btn_line'></div></div>"
            +"<div id='div_level'><div class='title1'>层次</div>"
            +"<div class='btn_line1 menuDiv_bottom1'><button id='1000'>1000</button><button id='925'>925</button><button id='850'>850</button>"
            +"<button id='700'>700</button><button id='500'>500</button><button id='200'>200</button></div></div>"
            ...
            +"<div class='btn_line1 menuDiv_bottom1'><button id='buttonDisplayPlot' style='outline:none;margin:2px;'>填值</button><button id='buttonDisplayFill' style='outline:none;margin:2px;'>填色</button><button id='buttonDisplayContour' style='outline:none; margin:2px;'>等值线</button><button id='buttonDisplayIsoSurface' style='outline:none; margin:2px;'>色斑图</button></div></div>";
        ...
        function openElement(element){
            ...
            if(element == "tmax" || element == "tmin"){
                me.yubaoshixiaoTools.numbers = [24,48,72,96,120,144,168,192,216,240];
            }
            else if(element == "r12"){
                me.yubaoshixiaoTools.numbers = [12,24,36,48,60,72,84,96,108,120,132,144,156,168,180,192,204,216,228,240];
            }
            else{
                me.yubaoshixiaoTools.numbers = [3,6,9,12,15,18,21,24,27,30,33,36,39,42,45,48,51,54,57,60,63,66,69,72,75,78,81,84,87,90,93,96,99,102,105,108,111,114,117,120,123,126,129,132,135,138,141,144,147,150,153,156,159,162,165,168,171,174,177,180,183,186,189,192,195,198,201,204,207,210,213,216,219,222,225,228,231,234,237,240];
            }
        ...
        if(!this.registerKeyDown) {
            this.registerKeyDown = true;
            //键盘按键事件，实现上翻、下翻
