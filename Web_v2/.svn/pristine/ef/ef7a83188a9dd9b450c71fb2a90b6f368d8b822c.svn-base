...
WeatherMap.Layer.LocalTiledCacheLayerWhiteMap = WeatherMap.Class(WeatherMap.CanvasLayer, {
    ...
    url:HOSTNAME+":3080/TiledCacheService/TiledCacheServlet?dir=${dir}&scale=${scale}&row=${row}&col=${col}&format=${format}",
    //url:"http://weatherone.com.cn/s/TiledCacheService/TiledCacheServlet?dir=${dir}&scale=${scale}&row=${row}&col=${col}&format=${format}",
